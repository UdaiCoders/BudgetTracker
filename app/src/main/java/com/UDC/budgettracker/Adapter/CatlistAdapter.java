...
public class CatlistAdapter extends RecyclerView.Adapter<CatlistAdapter.MyViewHolder> {
    ...
    public CatlistAdapter(Activity activity, List<ModelCategory> modelArrayList, ItemClick itemClick) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txtTitle.setText(modelArrayList.get(position).getName());

        holder.ivIcon.setImageResource(image[modelArrayList.get(position).getImage()]);
