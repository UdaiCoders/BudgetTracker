package com.UDC.budgettracker.Adapter;
...
import com.UDC.budgettracker.Model.ModelCategory;
import com.UDC.budgettracker.Others.ItemClick;
import com.UDC.budgettracker.R;

import java.util.List;

public class MoreCatlistAdapter extends RecyclerView.Adapter<MoreCatlistAdapter.MyViewHolder> {
    ...
    public static int[] image = {
            ...
            R.mipmap.ic_normal_transportation_09, R.mipmap.ic_normal_transportation_10,
            R.mipmap.ic_normal_transportation_11, R.mipmap.ic_normal_transportation_12,
            R.mipmap.ic_normal_transportation_13, R.mipmap.ic_normal_transportation_14,
            R.mipmap.ic_normal_transportation_15, R.mipmap.ic_normal_transportation_16,
            R.mipmap.ic_category_others_normal};

    public MoreCatlistAdapter(Activity activity,ItemClick onClick) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.row_more_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.ivIcon.setImageResource(image[position]);
